...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('site1.home') }}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">{{ __('admin.Categories_Components') }}</h6>
                        <a class="collapse-item" href="{{ route('Admin.Caregorys.index') }}">{{ __('admin.All_Categories') }} </a>
                        <a class="collapse-item" href="{{ route('Admin.Caregorys.create') }}">{{ __('admin.Add_Categories') }} </a>
                        <a class="collapse-item" href="{{ route('Admin.catag.trash') }}">{{ __('admin.trash') }} </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">{{ __('admin.Products_Utilities') }}</h6>
                        <a class="collapse-item" href="{{ route('Admin.products.index') }}">{{ __('admin.All_Products') }}</a>
                        <a class="collapse-item" href="{{ route('Admin.products.create') }}">{{ __('admin.Add_Products') }}</a>
                        <a class="collapse-item" href="{{ route('Admin.product.trash') }}">{{ __('admin.trash') }}</a>
...
{{--
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer" aria-labelledby="navbarDropdown">
    ...
    <!-- Page level plugins -->
    <script src="{{ asset('Adminasset/vendor/chart.js/Chart.min.j') }}s"></script>
