                    ...
                    <tbody>
                     ...
                     @foreach ($caregories as $categorie)
                      <tr class="">
                        ...
                        <td class="">
                            <a class="btn btn-info" href="{{ route('Admin.Caregorys.restor',$categorie->id) }}">recovery</a>
                             <form action="{{route('Admin.Caregorys.forcedelete',$categorie->id)}}" method="post" class="d-inline servideletebtn">
                                @csrf
                                @method('delete')
