                            ...
                            <form  action="{{ route('register') }}"method="POST" class="user">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        @enderror form-control-user" id="exampleFirstName"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        @enderror form-control-user" id="exampleLastName"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        @enderror form-control-user"
                                            id="exampleInputPassword" placeholder="Password" name="password" value="{{ old('password') }}" required autocomplete="password" autofocus>
                                            @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Repeat Password" name="password_confirmation" autocomplete="new-password">
                                    </div>
