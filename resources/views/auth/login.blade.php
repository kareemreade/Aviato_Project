                                ...
                                <div class="p-5">
                                    ...
                                    <form  action="{{ route('login') }}" method="POST" class="user">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @enderror " id="exampleInputPassword" placeholder="Password" name="password" required autocomplete="current-password">
                                                @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="text-center">
                                        <a style="font-size: 14px" href="{{ route('register') }}">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
